...
export const eu: Record<string, string> = {
  ...
  'time.caption':
    'Horrela sartzen da mapara gaur egun dagoen parkea, Katastroan erregistratutako eraikuntza-urtearen arabera. Urte ezaguna duten egungo eraikinen gainean.',
  ...
  'photo.epochs_a11y': 'Kanpainaka eskuragarri dauden aireko argazki ofizialak',
  'photo.epoch_birth': 'zure jaiotze-urtearen hurbilena',
