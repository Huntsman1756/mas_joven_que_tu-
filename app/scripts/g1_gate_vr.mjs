...
const browser = await chromium
  .launch({ channel: 'chrome', args: ['--disable-gpu'] })
  .catch(() => chromium.launch({ args: ['--disable-gpu'] }));
...
const STATES = [
  ...
  },
  {
    id: 'detail-desktop',
    vp: { width: 1440, height: 900 },
    url: '/?year=1987&place=leioa&lat=43.326&lon=-2.988&z=14.6&building=x',
    mobile: false,
    wait: 'map'
  },
  ...
  },
  {
    id: 'detail-mobile',
    vp: { width: 390, height: 844 },
    url: '/?year=1987&place=leioa&lat=43.326&lon=-2.988&z=14.6',
    mobile: true,
    wait: 'map'
  }
];
