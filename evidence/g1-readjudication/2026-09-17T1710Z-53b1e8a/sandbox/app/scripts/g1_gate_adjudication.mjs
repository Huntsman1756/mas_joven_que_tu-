...
const R = {
  meta: { candidate: '53b1e8a', named_candidate: '53b1e8a', utc: new Date().toISOString() },
  checks: {},
...
// Sandbox copy: CSP hash rechaza addScriptTag({content}); axe se sirve
// same-origin (script-src 'self'), igual que g1_a11y.mjs (commit 503f40c).
